<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                    ...
                    <tr>
                        <td valign="top" class="bannercell">
                            <a href="http://phing.info/">
                                <img src="http://phing.info/images/phing.gif" alt="http://phing.info/" align="left"
                                     border="0"/>
                            </a>
                        </td>
    ...
    <xsl:template match="build">
        ...
        <table border="1" cellspacing="2" cellpadding="3" width="100%" style="font-size:80%">
            <tr class="a">
                <td width="1">phing.file</td>
                <td>
                    <xsl:value-of select="substring-after(//message[contains(text(),'phing.file')], '->')"/>
                </td>
            </tr>
            <tr class="b">
                <td width="1">phing.version</td>
                <td>
                    <xsl:value-of select="substring-after(//message[contains(text(),'phing.version')], '->')"/>
                </td>
            </tr>
        </table>
        <!-- build information -->
