...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common"
    ...
    <xsl:template name="index.html">
        <html>
            <head>
                <title>
                    <xsl:value-of select="$document.title"/> Coverage Results
                </title>
            </head>
            <frameset cols="20%,80%">
                <frameset rows="30%,70%">
    ...
    <xsl:template name="stylesheet.css">
        ...
        TD.covered {
        FONT-SIZE: 2px; BACKGROUND: #00df00; BORDER-LEFT:#9c9c9c 1px solid;BORDER-TOP:#9c9c9c 1px
        solid;BORDER-BOTTOM:#9c9c9c 1px solid;
        color: #00df00;
        }
        TD.uncovered {
                        ...
                        <tr>
                            <td nowrap="nowrap">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <i>(<xsl:value-of
                                                select="format-number(@totalcovered div @totalcount, '0.0%')"/>)
                                        </i>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </td>
        ...
        <html>
            ...
            <body onload="open('allclasses-frame.html','classListFrame')">
                ...
                <table class="log" cellpadding="5" cellspacing="0" width="100%">
                    <tr class="a">
                        <td class="small">Packages:
                            <xsl:value-of select="count(package)"/>
                        </td>
                        <td class="small">Subpackages:
                            <xsl:value-of select="count(package/subpackage)"/>
                        </td>
                        <td class="small">Classes:
                            <xsl:value-of select="count(package/class) + count(package/subpackage/class)"/>
                        </td>
                        <td class="small">Methods:
                            <xsl:value-of select="@methodcount"/>
                        </td>
                        <td class="small">LOC:
                            <xsl:value-of
                                    select="count(package/class/sourcefile/sourceline) + count(package/subpackage/class/sourcefile/sourceline)"/>
                        </td>
                        <td class="small">Statements:
                            <xsl:value-of select="@statementcount"/>
                        </td>
                    </tr>
                </table>
                <br/>
                ...
                <table class="log sortable" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <xsl:for-each select="package">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{translate(@name,'._\','///')}/package-summary.html">
                                    <xsl:value-of select="@name"/>
                                </a>
                            </td>
                            <xsl:call-template name="stats.formatted"/>
    ...
    <xsl:template match="subpackage" mode="write">
        ...
        <xsl:variable name="package.dir">
            <xsl:if test="not($package.name = '')">
                <xsl:value-of select="translate($package.name,'._\','///')"/>
            </xsl:if>
            ...
            <body>
                ...
                <table width="100%">
                    <xsl:for-each select="subpackage">
                        ...
                        <tr>
                            <td nowrap="nowrap">
                                <a href="{translate(@name,'._\','///')}/subpackage-summary.html" target="classFrame">
                                    <xsl:value-of select="@name"/>
                                </a>
                                <xsl:choose>
                                    <xsl:when test="@totalcount=0">
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <H2>
                                ...
                                ::
                                <a href="subpackage-summary.html" target="classFrame">
                                    <xsl:value-of select="@name"/>
                                </a>
                            </H2>
                        </td>
        ...
        <html>
            ...
            <body onload="open('package-frame.html','classListFrame')">
                ...
                <table class="log" cellpadding="5" cellspacing="0" width="100%">
                    <tr class="a">
                        <td class="small">Subpackages:
                            <xsl:value-of select="count(subpackage)"/>
                        </td>
                        <td class="small">Classes:
                            <xsl:value-of select="count(class) + count(subpackage/class)"/>
                        </td>
                        <td class="small">Methods:
                            <xsl:value-of select="@methodcount"/>
                        </td>
                        <td class="small">LOC:
                            <xsl:value-of
                                    select="count(class/sourcefile/sourceline) + count(subpackage/class/sourcefile/sourceline)"/>
                        </td>
                        <td class="small">Statements:
                            <xsl:value-of select="@statementcount"/>
                        </td>
            ...
            <body onload="open('subpackage-frame.html','classListFrame')">
                ...
                <table class="log" cellpadding="5" cellspacing="0" width="100%">
                    <tr class="a">
                        ...
                        <td class="small">LOC:
                            <xsl:value-of select="count(class/sourcefile/sourceline)"/>
                        </td>
                        <td class="small">Statements:
                            <xsl:value-of select="@statementcount"/>
                        </td>
        ...
        <xsl:variable name="fullpackage.name">
            ...
            <xsl:if test="not($subpackage.name='')">
                <xsl:choose>
                    ...
                    <xsl:when
                            test="contains((ancestor::package)[last()]/@name, '_') or contains($subpackage.name, '_')">
                        <xsl:text>_</xsl:text>
                    </xsl:when>
                    <xsl:when
                            test="contains((ancestor::package)[last()]/@name, '\') or contains($subpackage.name, '\')">
                        <xsl:text>\</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:text>.</xsl:text>
            ...
            <body>
                ...
                <table class="log" cellpadding="5" cellspacing="0" width="100%">
                    <tr class="a">
                        ...
                        <td class="small">LOC:
                            <xsl:value-of select="count(sourcefile/sourceline)"/>
                        </td>
                        <td class="small">Statements:
                            <xsl:value-of select="@statementcount"/>
                        </td>
    ...
    <xsl:template name="pageHeader">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="bannercell" rowspan="2">
                    <a href="http://www.phing.info/">
                        <img src="http://www.phing.info/images/phing.gif" alt="http://www.phing.info/" align="left"
                             border="0"/>
                    </a>
                </td>
            ...
            <tr>
                <td style="text-align:right">Designed for use with <a href='http://www.phpunit.de'>PHPUnit</a>, <a
                        href='http://www.xdebug.org/'>Xdebug
                </a> and <a href='http://www.phing.info/'>Phing</a>.
                </td>
            </tr>
        </table>
        <hr size="1"/>
    ...
    <xsl:template name="pageFooter">
        <table width="100%">
            ...
            <tr>
                <td class="small">Report generated at
            ...
            <xsl:otherwise>
                ...
                <td>
                    <xsl:variable name="leftwidth">
                        <xsl:value-of select="format-number((@totalcovered * 200) div @totalcount,'0')"/>
                    </xsl:variable>
                    <xsl:variable name="rightwidth">
                        <xsl:value-of select="format-number(200 - (@totalcovered * 200) div @totalcount,'0')"/>
                    </xsl:variable>
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" style="display: inline">
                        <tr>
                            <xsl:choose>
    ...
    <xsl:template name="create.package-summary.link">
        ...
        <a target="classFrame">
            <xsl:attribute name="href">
                ...
                <xsl:value-of select="translate($package.name,'._\','///')"/>/package-summary.html
            </xsl:attribute>
