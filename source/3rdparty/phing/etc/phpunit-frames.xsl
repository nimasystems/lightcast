...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common"
            ...
            <body>
                ...
                <table width="100%">
                    <xsl:for-each select="/testsuites/testsuite[./@package = $name]">
                        ...
                        <tr>
                            <td nowrap="nowrap">
                                <a href="{$class.dir}.html" target="classFrame">
                                    <xsl:value-of select="@name"/>
                                </a>
                            </td>
                        </tr>
            ...
            <td nowrap="nowrap">
                <a target="classFrame">
                    <xsl:attribute name="href">
                        ...
                        <xsl:value-of select="translate(@name,'/','_')"/><xsl:text>.html</xsl:text>
                    </xsl:attribute>
                    <xsl:value-of select="@name"/>
                </a>
            </td>
    ...
    <xsl:template name="package.summary">
        ...
        <html>
            <head>
                <title>Unit Test Results: Package
                    <xsl:value-of select="$name"/>
                </title>
                <xsl:if test="$output.sorttable = 1">
                    <script language="JavaScript" src="http://www.phing.info/support/sorttable.js"/>
    ...
    <xsl:template name="pageHeader">
        ...
        <table width="100%">
            <tr>
                <td align="left"></td>
                <td align="right">Designed for use with <a href='http://www.phpunit.de'>PHPUnit</a> and <a
                        href='http://www.phing.info/'>Phing</a>.
                </td>
            </tr>
        </table>
        <hr size="1"/>
