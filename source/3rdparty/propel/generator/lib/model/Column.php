...
private $needsTransactionInPostgres;
    ...
    public function getDefaultValueString()
    {
        ...
        if ($defaultValue !== null) {
            ...
            } else if ($this->isTextType() || $this->getDefaultValue()->isExpression()) {
                $dflt = "'" . str_replace("'", "\'", $defaultValue->getValue()) . "'";
            } else if ($this->getType() == PropelTypes::BOOLEAN) {
    ...
    public function setTypeFromString($typeName, $size)
    {
        ...
        } else if (strpos($tn, "INT") !== false) {
            $this->domain->setType(PropelTypes::INTEGER);
        } else if (strpos($tn, "FLOAT") !== false) {
            $this->domain->setType(PropelTypes::FLOAT);
        } else if (strpos($tn, "DATE") !== false) {
            $this->domain->setType(PropelTypes::DATE);
        } else if (strpos($tn, "TIME") !== false) {
    ...
    protected function setupObject()
    {
        try {
            ...
            } else if ($this->getTable()->getAttribute('columnPrefix', null) !== null) {
            ...
            } else if ($this->getTable()->getAttribute('defaultAccessorVisibility', null) !== null) {
                $this->setAccessorVisibility($this->getTable()->getAttribute('defaultAccessorVisibility'));
            } else if ($this->getTable()->getDatabase()->getAttribute('defaultAccessorVisibility', null) !== null) {
            ...
            } else if ($this->getTable()->getAttribute('defaultMutatorVisibility', null) !== null) {
                $this->setMutatorVisibility($this->getTable()->getAttribute('defaultMutatorVisibility'));
            } else if ($this->getTable()->getDatabase()->getAttribute('defaultMutatorVisibility', null) !== null) {
            ...
            } else if ($this->getAttribute("defaultExpr") !== null) {
            ...
            if ($this->getAttribute('valueSet', null) !== null) {
                ...
                $this->valueSet = $valueSet;
            } else if (preg_match('/enum\((.*?)\)/i', $this->getAttribute('sqlType', ''), $matches)) {
                if (version_compare(PHP_VERSION, '5.3.0', '>=')) {
