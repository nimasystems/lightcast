...
class lcPropelLogger extends lcSysObj
{
	...
	private function getInternalLoggerSeverity($propel_severity)
	{
		...
		{
			case Propel::LOG_EMERG: return lcLogger::LOG_EMERG;
			case Propel::LOG_ALERT: return lcLogger::LOG_ALERT;
			case Propel::LOG_CRIT: return lcLogger::LOG_CRIT;
			case Propel::LOG_ERR: return lcLogger::LOG_ERR;
			case Propel::LOG_WARNING: return lcLogger::LOG_WARNING;
			case Propel::LOG_NOTICE: return lcLogger::LOG_NOTICE;
			case Propel::LOG_INFO: return lcLogger::LOG_INFO;
